<nav class="bg-white" x-data="{ isOpen: false }">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              @if (Auth::check() && Auth::user()->role == 'ketuatim')
                <x-nav-link href="/monitoringkegiatan" :active="request()->is('home')">Monitoring Kegiatan</x-nav-link>
                <x-nav-link href="/monitoringpegawai" :active="request()->is('monitoring')">Monitoring Pegawai</x-nav-link>  
              @endif
            ...
            <div class="relative ml-3">
              ...
              <div x-show="isOpen"
                ...
                <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                  @csrf
                    <button type="submit" class="block px-4 py-2 text-sm text-gray-700" style="background: none; border: none; cursor: pointer;">
                        Sign out
                    </button>
                </form>
              </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <x-nav-link href="/monitoring" :active="request()->is('monitoring')">Monitoring</x-nav-link>
      </div>
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          <form method="POST" action="{{ route('logout') }}" style="display: inline;">
            @csrf
              <button type="submit" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" style="background: none; border: none; cursor: pointer;">
                  Sign out
              </button>
          </form>        
        </div>
