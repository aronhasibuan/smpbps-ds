<x-layout>
    <div class="bg-white dark:bg-gray-800">
        <div class="py-4 px-4 mx-auto">
            ...
            <a href="/kepalabps/daftarpegawai" class="font-medium text-base text-blue-600 hover:underline">&laquo; Kembali</a>

            <h2 class="mb-4 mt-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Pegawai</h2>
