        ...
        <div class="flex justify-between items-center mb-6">
            ...
            @if (Auth::check() && Auth::user()->user_role == 'kepalabps')
                <a href="{{ route('create-employee-page') }}" class="inline-flex items-center px-3 py-2 sm:px-4 sm:py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs sm:text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                    ...
                    <span class="xs:inline">Tambah Pegawai</span>
                </a>
            @endif
        </div>
            ...
            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
                    <div class="w-full md:w-1/2">
                        <form action="{{ route('employee-list-page') }}" method="GET" class="flex items-center gap-2">
                ...
                @if(request()->has('search') && request('search') != '')
                    <div class="mt-4">
                        <a href="{{ route('employee-list-page') }}" 
                        ...
                        aria-label="Kembali ke semua Pegawai">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <button onclick="openDeleteModal('{{ route('delete-user', $user->id) }}', '{{ $user->user_full_name }}')" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center py-8">
                                        ...
                                        <a href="{{ route('employee-list-page') }}" class="mt-2 text-sm text-blue-600 hover:underline">
